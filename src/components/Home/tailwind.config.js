...
module.exports = {
  ...
  theme: {
    ...
    backgroundImage: {
      none: 'none',
      'gradient-white': 'linear-gradient(112.84deg, #FFFFFF 0.33%, #EDF5F2 100%)',
      'gradient-indigo': 'linear-gradient(98.24deg, #5D75F3 0%, #A279F9 100%)',
      'gradient-fuchsia': 'linear-gradient(112.84deg, #46BAEB 0.33%, #AF2CFF 38.23%, #F790AF 65.22%, #C1ABFF 100%)',
      ...
      'gradient-cyan': 'linear-gradient(90deg, rgba(108,213,246,1) 0%, rgba(248,157,92,1) 50%, rgba(91,106,240,1) 100%)',
      'gradient-cyan2': 'linear-gradient(98.24deg, #6CD5F7 0%, #FEE2CE 35.94%, #B0A9DF 69.27%, #5B6AF0 100%)',
      'gradient-black': 'linear-gradient(98.24deg, #212121 0.01%, #1D1D1D 100%)',
      'gradient-red': 'linear-gradient(98.24deg, #FF9483 0%, #F17980 100%)',
      'gradient-green': 'linear-gradient(98.24deg, #CEE9C1 0%, #83C8DE 100%)',
      'gradient-violet': 'linear-gradient(98.24deg, #E0AEF8 1.56%, #3168F5 100%)',
      'gradient-pink': 'linear-gradient(98.24deg, #FAF5F4 0%, #F4E3E4 55.95%, #F0D5D7 100%)',
      'gradient-pink2': 'linear-gradient(112.84deg, #FFFFFF 0.33%, #EEDFEF 100%)',
      'gradient-gray': 'linear-gradient(125.68deg, #F4F4F5 0.59%, #FBFBFB 100%)',
      'gradient-gray2': 'linear-gradient(98.24deg, #FFFFFF 0%, #F9F9FF 47.4%, #EBECF7 100%)',
    ...
    fontFamily: {
      ...
      heading: '"Outfit", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"',
    ...
    fontSize: {
      ...
      xl: ['1.313rem', { lineHeight: '1.75rem' }],
      ...
      '8xl': ['3.25rem', { lineHeight: '1' }],
      '9xl': ['3.625rem', { lineHeight: '1' }],
      '10xl': ['3.75rem', { lineHeight: '1' }],
      '11xl': ['4rem', { lineHeight: '1' }],
      '12xl': ['4.375rem', { lineHeight: '1' }],
      '13xl': ['5rem', { lineHeight: '1' }],
      '14xl': ['6rem', { lineHeight: '1' }],
      '15xl': ['6.875rem', { lineHeight: '1' }],
