...
const Signin = () => {
    return (
        <section class="relative pt-24 lg:py-44">
            <img class="hidden lg:block absolute top-0 left-0 h-full w-1/2" src="gradia-assets/images/login/Saly-38.png" alt="" />
            <div class="container px-4 mx-auto">
                <div class="h-full lg:w-1/2   ml-auto">
                    <div class="relative max-w-xs lg:max-w-md mx-auto text-center">
                        ...
                        <h2 class="text-2xl text-gray-700 font-semibold mb-2">Log in to your account</h2>
                        <p class="text-gray-700 font-medium mb-10">Welcome back! Please enter your details.</p>
                        <form action="">
                            ...
                            <div class="flex flex-wrap items-center justify-between mb-6">
                                ...
                                <div class="w-full sm:w-auto"><Link to="/signup"><div class="inline-block text-xs font-semibold text-blue-500 hover:text-blue-600"> Dont have Account ?Signup</div></Link></div>
                            </div>
