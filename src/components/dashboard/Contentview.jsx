                  ...
                  <table class="w-full min-w-max">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="py-3 pr-4 border-b border-neutral-100"><span class="text-sm">Ashwanth</span></td>
                        <td class="py-3 pr-4 border-b border-neutral-100" >hello its an api call to  just test data loading</td>
