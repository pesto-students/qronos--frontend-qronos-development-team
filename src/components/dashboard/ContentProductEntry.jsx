...
const ContentEntry = () => {
    ...
    const publishData = async () => {
        ...
        if (routeParams) {
            if (!title) return
            const url = `${process.env.REACT_APP_.API_URL}/product/${databaseId}/${routeParams}`
            ...
            if (!title) return
            const url = `${process.env.REACT_APP_.API_URL}/product/${databaseId}`
    ...
    const getValues = async () => {
        try {
            const result = await axios.get(`${process.env.REACT_APP_.API_URL}/product/${routeParams}`, {
                params: {
                    email: user.email,
