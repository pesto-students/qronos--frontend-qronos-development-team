                ...
                <div class="w-full sm:w-1/2">
                  <div class="text-center p-5 border-blue-200">
                    ...
                    {file && <div class="font-medium px-8">
                      <p className='py-6'>Selected file: {file.name}</p>                      <button class="inline-flex flex-wrap items-center justify-center px-6 py-2.5 border hover:border-neutral-200 rounded-lg bg-purple-200 text-lg font-bold" onClick={fileUpload}>
