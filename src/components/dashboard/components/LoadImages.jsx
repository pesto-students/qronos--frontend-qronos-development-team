      ...
      <div class="flex flex-wrap items-center -m-2">
        ...
        <div class="w-full md:w-1/2 p-2">
          <div class="flex flex-wrap md:justify-end">
            <div class="w-auto"><a class="inline-flex flex-wrap items-center justify-center px-5 py-2.5 w-full font-medium text-sm text-center text-neutral-50 hover:text-neutral-100 bg-neutral-600 hover:bg-opacity-95 rounded-lg focus:ring-4 focus:ring-neutral-400" href="#">+ Upload Asset</a></div>
      ...
      <div class="flex divide-y sm:divide-y-0 sm:divide-x justify-center p-20">
        ...
        <div class="w-full sm:w-1/2">
          <div class="text-center p-5 border-blue-200">
            ...
            <a class="inline-flex flex-wrap items-center justify-center px-6 py-2.5 border hover:border-neutral-200 rounded-lg bg-purple-200 text-lg font-bold" href="#">
              ...
              </svg><span class="font-medium">Add A Asset</span></a>
          </div>
        </div>
      </div>
    </div>
