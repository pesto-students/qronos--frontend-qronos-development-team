...
const Sidebar = () => {
    ...
    return (
        <div>
                ...
                <div class="w-full xl:w-auto px-2 xl:mr-10">
                    <div class="flex items-center justify-between">
                        <a class="inline-flex items-center h-7" href="#">
                            <img src="gradia-assets/images/Logomark.png" alt="" /></a>
                        <div class="absolute">
                            <button class="navbar-burger text-gray-400 hover:text-gray-300 focus:outline-none" onClick={() => setopensidebar(true)}>
            ...
            <div class={`navbar-menu hidden relative ${opensidebar ? "absolute" : "hidden"} z-50  xl:flex xl:flex-col  `}>
                ...
                <div class="fixed inset-0 w-16 bg-white">
                    <div class="flex justify-center py-4 bg-white">
                        <img src="gradia-assets/images/Logomark.png" alt="Logo " />
                    </div>
