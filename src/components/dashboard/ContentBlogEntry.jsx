...
const ContentEntry = () => {
    ...
    const getValues = async () => {
        try {
            ...
            const result = await axios.get(`${process.env.API_URL}/blog/${routeParams}`, {
                params: {
                    email: user.email,
    ...
    const publishData = async () => {
        ...
        if (routeParams) {
            if (!title) return
            const url = `${process.env.API_URL}/blog/${databaseId}/${routeParams}`
            ...
            if (!title) return
            const url = `${process.env.API_URL}/blog/${databaseId}`
            console.log(url);
    ...
    return (
        <body>
            <Seo
                title='Edit Blog Entry | The Ultimate Webinar Tool | QRONOS'
                description='Edit Blog Entry | The Ultimate Webinar Tool'
            />
            <div class="relative">
                <Sidebar />
