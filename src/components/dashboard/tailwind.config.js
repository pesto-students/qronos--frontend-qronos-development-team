module.exports = {
  ...
  theme: {
    ...
    backgroundImage: {
      ...
      'gradient-purple-left': 'linear-gradient(90deg, #FC6060 0.06%, #C160FC 33.37%, #7B60E8 69.29%, #3F3CFF 100%)',
      'gradient-purple-left-dark': 'linear-gradient(90deg, #EA3A3A 0.06%, #A12DE8 33.37%, #5A3ADA 69.29%, #2320F0 100%)',
      'gradient-purple-top': 'linear-gradient(180deg, #FC6060 0%, #C160FC 33.33%, #7B60E8 69.27%, #3F3CFF 100%)',
      'gradient-banner': 'linear-gradient(360deg, #0D192B 0%, rgba(18, 24, 32, 0) 100%)'
    },
    ...
    boxShadow: {
      ...
      '3xl': '0px 24px 48px rgba(12, 21, 35, 0.2)',
      '4xl': '0px 20px 40px rgba(0, 0, 0, 0.14)',
      '5xl': '0px 8px 22px -6px rgba(24, 39, 75, 0.12), 0px 14px 64px -4px rgba(24, 39, 75, 0.12)',
      '6xl': '0px 4px 30px rgba(0, 0, 0, 0.08)',
